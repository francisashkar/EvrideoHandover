...
export const CONTACTS_COLLECTION = 'noc_contacts'
export const HANDOVER_COLLECTION = 'noc_handover'
export const RUNBOOK_COLLECTION = 'noc_runbook'
export const INCIDENTS_COLLECTION = 'noc_incidents'
export const TAGS_COLLECTION = 'noc_tags_meta'
